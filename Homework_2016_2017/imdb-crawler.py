...
import pattern
from pattern.web import URL, DOM, ELEMENT, plaintext
...
def scrape_top_250(url):
    ...
    print find_urls('http://www.imdb.com/chart/top?ref_=nv_mv_250_6', unique=True)
...
if __name__ == '__main__':
    ...
    top250movies = extract_top250movies(dom)

    # Write the CSV file to disk (including a header)
    with open(OUTPUT_CSV, 'wb') as output_file:
        save_csv(output_file, top250movies)