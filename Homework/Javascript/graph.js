...
var xTransform = createTransform(domainX, rangeX);
var yTransform = createTransform(domainY, rangeY);

/*****************************************
pushing converted coordinates to array
*****************************************/
var xArray = []
var yArray = []

for (i = 0; i < x.length; i++) {
	xArray.push(xTransform(i))
	yArray.push(adjustedHeight - yTransform(y[i]))
}
...
/*****************************************
drawing graph borders
*****************************************/
ctx.beginPath();
ctx.moveTo(0, 0);
ctx.lineTo(0, adjustedHeight);
ctx.lineTo(c.width, adjustedHeight);
ctx.stroke();
...
*****************************************/
ctx.font = "20px Arial";
ctx.fillText("Daily average temperature", 10, 16);

ctx.font = "12px Arial";
ctx.fillText("De Bilt 1986", 10, 31);

ctx.font = "12px Arial";
ctx.fillText("Days", c.width/2, c.height - 5);

ctx.save();
ctx.translate(c.width / 2, adjustedHeight / 2);
ctx.rotate(-Math.PI/-2);
ctx.font = "12px Arial";
ctx.fillText("Temperature in Celsius", -150, c.height * (37 / 50));
ctx.restore();